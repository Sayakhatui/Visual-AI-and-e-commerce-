...
small_area_objects = [
    ...
    'Jewelry', 'Necklace', 'Pendant', 'Perfume', 'Pin', 'Ring', 'Scarf', 'Tie', 'Wristwatch'
]
...
def detect_labels(image_bytes):
    response = reko_client.detect_labels(Image={'Bytes': image_bytes}, MinConfidence=5)  # Set MinConfidence to 0
